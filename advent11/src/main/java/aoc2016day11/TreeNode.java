 ...
 * A <code>TreeNode</code> is a general-purpose node in a tree data
 * structure.
 ...
 * use of which is left to the user.  Asking a <code>TreeNode</code> for its
 ...
 * <p>
 * While TreeNode implements the MutableTreeNode interface and
 * will allow you to add in any implementation of MutableTreeNode not all
 * of the methods in TreeNode will be applicable to all
 * MutableTreeNodes implementations. Especially with some of the enumerations
 * that are provided, using some of these methods assumes the
 * TreeNode contains only DefaultMutableNode instances. All
...
public class TreeNode<T> implements Iterable<T>, Cloneable, Serializable
{
    ...
    public List<TreeNode<T>> getPath() {
        List<TreeNode<T>> pathFromHereToRoot = new ArrayList<>();
        addToPathToRoot(pathFromHereToRoot);
        Collections.reverse(pathFromHereToRoot);
        return pathFromHereToRoot;
    }
    ...
    protected void addToPathToRoot(List<TreeNode<T>> pathToRoot) {
        ...
        TreeNode<T> parent = getParent();
        if (parent != null) {
            parent.addToPathToRoot(pathToRoot);
        }
    }
    ...
    public List<T> getUserObjectPath() {
        ...
        List<T> retPath = Stream.generate(() -> (T) null).limit(realPath.size()).collect(Collectors.toList());
